...
I generated the keys stored in this repo at `sigstore/cosign/keys/cosign.key` and `sigstore/cosign/keys/cosign.pub` through the handy `cosign generate keypair`.
